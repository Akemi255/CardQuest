export const RenderRankingCards = ({ data, index }) => {
  ...
  return (
    ...
    >
      <div
        className={`${borderColorClass} border-animado bg-white rounded-lg shadow-md overflow-hidden transition duration-300 transform hover:shadow-xl hover:scale-105 cursor-pointer h-full flex flex-col justify-center items-center`}
      >
