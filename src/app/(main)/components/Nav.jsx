    ...
    <div className="flex flex-col gap-2 bg-background2 justify-between h-full">
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            className="hover:bg-background-surface-200 bg-background2 border-border-button w-auto flex flex-row justify-start h-auto p-0 text-primary-foreground-light hover:text-primary-foreground-morelighter border mx-2 mb-2"
          >
